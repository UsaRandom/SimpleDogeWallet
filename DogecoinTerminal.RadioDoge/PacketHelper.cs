...
namespace DogecoinTerminal.RadioDoge
{
    internal static class PacketHelper
    {
        ...
        internal static byte[] CreatePacket(NodeAddress destAddress, NodeAddress localAddress, byte[] payload)
        {
            ...
            packetBytes.AddRange(CreateCommandHeader(commandType, (byte)(messageSize + 2)));
            packetBytes.AddRange(CreateCommandHeader(commandType, messageSize));
