...
namespace Lib.Dogecoin.Interop
{
    ...
    internal static class LibDogecoinInterop
    {
		...
		[DllImport(DLL_NAME, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
		public static extern int dogecoin_generate_mnemonic_encrypt_with_sw(
			[Out, MarshalAs(UnmanagedType.LPArray)] char[] mnemonic,
			int file_num,
			...
			[MarshalAs(UnmanagedType.LPArray)] char[] password);



		[DllImport(DLL_NAME, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
		public static extern int dogecoin_decrypt_mnemonic_with_sw(
			[Out, MarshalAs(UnmanagedType.LPArray)] char[] mnemonic,
			int file_num,
			[MarshalAs(UnmanagedType.LPArray)] char[] password);
		/* 
